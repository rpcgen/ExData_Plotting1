...
plot4 <- function() {
    par(mfcol=c(2,2))
    plot(hpc$DateTime, hpc$GlobalActivePower, type='l', xlab='', ylab='Global Active Power')
    ...
    legend('topright', legend=colnames(hpc)[5:7], col=c('black', 'blue', 'red'), lty=c(1,1), bty='n')
    plot(hpc$DateTime, hpc$Voltage, type='l', xlab='Date Time', ylab='Voltage')
    plot(hpc$DateTime, hpc$GlobalReactivePower, type='l', xlab='Date Time', ylab='Global Readcive power')
}
